...
const HeadphonesHome = () => {
 ...
 >    
      <Cards pic="public\Tronsmart-Q20S-600x600.webp"
            detail="Amaze Strong Base Wireless Headphone With 24hrs Time A650"
            price="Rs 11,999"
            button="Add to Cart"
/>
      <Cards pic="public\CMF-Nothing-Headphones-Pro-300x300.webp"
            detail="CMF Nothing Headphones Pro"
            price="Rs 39,999"
            button="Add to Cart"
/>
      <Cards pic="public\QCY-Heroad-V200-300x300.webp"
            detail="QCY Heroad V200 7.1 Virtual Headset H4GM"
            price="Rs 12,499"
            button="Add to Cart"
/>
      <Cards pic="public\Yolo-Nirvana-Headphone-Y-512-Black-300x300.webp"
            detail="Yolo Nirvana Wireless Headphones with Active Noise Cancellation Y-512"
            price="Rs 7,499"
            button="Add to Cart"
/>
      <Cards pic="public\Yolo-Focus-Heaphone-Y-511-Black-300x300.webp"
...
/>
 ...
 <div className='flex items-center justify-between px-2'
 >    
      <Cards pic="public\Yolo-Vogue-Headphone-Y-510-Black-300x300.webp"
            detail="Amaze Strong Base Wireless Headphone With 24hrs Time A650"
            price="Rs 6,999"
            button="Add to Cart"
/>
      <Cards pic="public\Amaze-A655-300x300.webp"
