...
const Sell = () => {
  return (
    <div>
        ...
        <Cards pic="/Soundpeats-T3-Pro-ANC-Bluetooth-Earbuds-300x300.webp"
            detail=" Soundpeats T3 Pro ANC Bluetooth Earbuds"
            price="Rs 14,999"
            button="Add to Cart"
            />  
          <Cards pic="/HaylouSolarUltraSmartWatch-Black-300x300.webp"
            detail=" Haylou Solor Ultra Smart Watch"
            price="Rs 3,699"
            button="Add to Cart"
            />  
             <Cards pic="/DJI-Osmo-Mobile-7P-Gimbal-300x300.webp"
            detail="DJI Osmo Mobile 7p Gimble"
            price="Rs 39,999"
            button="Add to Cart"
            />  
             <Cards pic="/tws-black_1920x_4_4027e963-7e73-4ec7-8e9e-2236a71d7fb0_1920x-300x300.webp"
            detail="CMF by Nothing Buds pro with Hybrid ANC"
            price="Rs 12,999"
            button="Add to Cart"
            />  
             <Cards pic="/RedmiBuds6Lite-300x300.webp"
...
<div className='flex justify-center gap-1.5'>
  <Cards pic="/watch-wrist.webp"
            detail="CMF by Nothing Watch Pro 2 with AMOLE"
            price="Rs 15,299"
            button="Add to Cart"
/>  
             <Cards pic="/SAMSUNG-Galaxy-Buds-3-Pro-300x300.webp"
            detail="Samsung Galaxy Buds 3pro"
            price="Rs 32,499"
            button="Add to Cart"
 />  
             <Cards pic="/Buds-FE-1-300x300.webp"
            detail="Samsung Galaxy Buds FE"
            price="Rs 13,99"
            button="Add to Cart"
 />  
             <Cards pic="/watch-6-classic-47-600x600-1-300x300.webp"
            detail="Samsung Watch 6 classic 47mm R960"
            price="Rs 44,999"
            button="Add to Cart"
 />   
   <Cards pic="/Xiaomi-TV-Box-S-2nd-Gen-4K-Ultra-HD-1-1-300x300.webp"
