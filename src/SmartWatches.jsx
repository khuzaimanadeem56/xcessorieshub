...
const SmartWatches = () => {
  return (
    ...
    >
      <Cards pic="/Mibro-Watch-C4-300x300.webp"
            detail="Mibro Watch C4"
            price="Rs 3,999"
            button="Add to Cart"
    />
      <Cards pic="/OnePlus-Watch-4-300x300.webp"
            detail="OnePlus Watch 4"
            price="Rs 91,999"
            button="Add to Cart"
    />
          <Cards pic="/Amazfit-Bip-Max-300x300.webp"
            detail="Amazfit Bip Max Smartwatch"
            price="Rs 34,999"
            button="Add to Cart"
    />
        <Cards pic="/Xiaomi-Watch-S5-Black-300x300.webp"
    ...
    <div className='flex justify-center gap-10'
    >
      <Cards pic="/HUAWEI-Watch-Fit-5-Pro-300x300.webp"
            detail="HUAWEI Watch Fit 5 Pro"
            price="Rs 74,999"
            button="Add to Cart"
    />
      <Cards pic="/Huawei-Watch-Fit-5-1-300x300.webp"
            detail="HUAWEI Watch Fit 5"
            price="Rs 44,999"
            button="Add to Cart"
    />
          <Cards pic="/HUAWEI-Band-11-Black-300x300.webp"
            detail="HUAWEI Band 11"
            price="Rs 14,999"
            button="Add to Cart"
    />
        <Cards pic="/Aurafit-ELLA-3-AM28-300x300.webp"
